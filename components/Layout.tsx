...
import { ThemeOptions, ThemeProvider } from "contexts/theme-context";
...
const Layout = ({ children }: LayoutProps) => {
  ...
  const [theme, _setTheme] = useState<ThemeOptions>("light");
  const [colour, _setColour] = useState<AccentColourOptions>("violet");

  useEffect(function () {
    setTheme(getTheme());
    setColour(getAccentColour());
  }, []);
  ...
  function setColour(theme: AccentColourOptions) {
    _setColour(theme);
  ...
  return (
    <ThemeProvider {...{ theme, setTheme }}>
      <AccentColourProvider {...{ colour, setColour }}>
        <LazyMotion strict features={domAnimation}>
          <div className={classNames("h-full", theme, `accent-${colour}`)}>
