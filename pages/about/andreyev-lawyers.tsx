            ...
            <div className="relative overflow-hidden">
              ...
              >
                <div className="transition-colors dark:text-white">
                  ...
                  <div>
                    Originally a CRM, the system quickly evolved into a full
                    service business managment platform used daily by all
                    members of the firm across multiple Australian states.
                  </div>
                </div>
