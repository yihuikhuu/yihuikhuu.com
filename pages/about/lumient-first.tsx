    ...
    {({ theme }) => (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Yihui Khuu at Lumient 2014 - 2018"
          />
        </Head>
        <Hero>
          <Title size="large">
            ...
            <div className="relative overflow-hidden">
              ...
              >
                <div className="transition-colors dark:text-white">
                  ...
                  <div>
                    I was responsible for the development of several projects
                    using a variety of different technologies based on what best
                    suits the project.
                  </div>
                </div>
